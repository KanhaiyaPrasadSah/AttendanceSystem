...
export default function AdminNavbar() {
    ...
    const NotificationOnClick = async (e) => {
        ...
        //     try {
        //         const res = await axios.get("https://6a3cb81cd8e212699e22a82b.mockapi.io/api/v1/Admin");
    ...
    // const displayUserType = NotificationDetails.filter((user) => user.userType === "User"? user.userType ="Student": user.userType = "Staff");
